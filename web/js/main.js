...
eniOil.prototype.render = function () {
    this.app.contentTag.innerHTML =
        '<div class="container"> \
            <div id="layer-1" class="layer" ><img src="' + this.app.path + 'images/eo-img-01-01.png"/></div> \
            <div id="layer-2" class="layer"> \
                <img src="' + this.app.path + 'images/eo-img-02-01-b.png"/> \
                <form id="form" class="form"> \
                    <input type="text" id="name" placeholder="Nama:" required> \
                    <input type="tel" id="hp" placeholder="No HP:" required> \
                    <div class="last"> \
                        <button id="submit" class="btn"><img src="' + this.app.path + 'images/eo-bttn-01-01.png"/></button> \
                    </div> \
                </form> \
            </div> \
...
eniOil.prototype.style = function () {
    ...
    css += '#layer-1 { display: block; } #layer-1 img { width: 320px; height: 480px; position: relative; cursor: pointer; } ';
    css += '#layer-2 { display: none; } ';
    css += '#layer-3 { display: none; } ';
    css += '.layer { width: 320px; height: 480px; position: absolute; top: 0; left: 0;} ';
    css += '.form { position: absolute; bottom: 90px; left: 0; text-align: center; } .form input { width: 208px; height: 30px; padding: 0 10px; font-size: 16px; } .form .last { margin-top: 10px; } ';
    css += '.btn { background: none; border: 0; }';
...
eniOil.prototype.events = function () {
    ...
    this.layer1.addEventListener('click', function (e) {
        _this.layer2.style.display = 'block';
        e.target.style.display = 'none';

        /* tracker */
        _this.app.tracker('E', 'frame_1');
    })
